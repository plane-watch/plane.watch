...
type (
	Client struct {
		...
		locationChan  chan *export.PlaneLocationJSON
...
func NewClient(host string) *Client {
	return &Client{
		host:         host,
		secure:       true,
		locationChan: make(chan *export.PlaneLocationJSON, 100),
		// response channels
...
func (c *Client) LocationUpdates() chan *export.PlaneLocationJSON {
