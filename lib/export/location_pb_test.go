...
//	loc := getRefLocation()
//	list := make([]*PlaneLocationJSON, 100)
//	for i := 0; i < 100; i++ {
//		list[i] = loc
//	}
...
//	loc := getRefLocation()
//	list := make([]*PlaneLocationJSON, 100)
//	list2 := make([]*PlaneLocationJSON, 0)
//	for i := 0; i < 100; i++ {
//		list[i] = loc
//	}
//	var jsonFast = jsoniter.ConfigFastest
...
//	loc := getRefLocation()
//	list := PlaneLocations{
//		PlaneLocationJSON: make([]*PlaneLocationPB, 100),
//	}
//	for i := 0; i < 100; i++ {
//		list.PlaneLocationJSON[i] = &loc.PlaneLocationPB
//	}
//	b.ResetTimer()
//	for i := 0; i < b.N; i++ {
